  ...
  return (
    <div className={styles.productInCart}>
      ...
      <div className={styles.garbageDump}>
        <form>
          <button
            className={styles.garbageDumpButton}
            type="button"
...
function ListProductInCart() {
  ...
  const handleIntoOrder = async () => {
    ...
    try {
      ...
      console.log(responseText);
      alert(
        "Đơn hàng đã được tạo thành công. Vui lòng đợi nhân viên xác nhận!"
      );
      updateProduct();
    } catch (error) {
      console.error("Error:", error);
    ...
    <div className={styles.bodyGioHang}>
      ...
      <div className={styles.orderInfo}>
        ...
        <div className={styles.customPhone}>
          ...
          <span className={styles.customPhoneValue}>
            {cusInfo[0]?.SoDienThoai}
          </span>
        </div>
