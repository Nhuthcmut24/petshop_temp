      ...
      <div className={styles.info}>
        ...
        <div className={styles.infoContainer}>
          <div className={styles.infoRight}>
            <ul>
              <li>
                <BsFillTelephoneFill /> Số điện thoại
              </li>
          ...
          <div className={styles.infoRight}>
            <ul>
              ...
              <li className={styles.infoTel}>
                {staffInfo[0].Email === null
                  ? "Chưa cập nhật"
                  : staffInfo[0].Email}
              </li>
            </ul>
            <button className={styles.infoButton2} onClick={handelUpdateEmail}>
              Cập nhật
            </button>
          </div>
          <div className={styles.infoRight}>
            <ul>
              ...
              <li className={styles.infoTel}>
                {staffInfo[0].Diachi === null
                  ? "Chưa cập nhật"
                  : staffInfo[0].DiaChi}
              </li>
            </ul>
            <button
              className={styles.infoButton3}
