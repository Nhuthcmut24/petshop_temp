...
function Quanlisanpham() {
  ...
  // const data = [
  //     {TenFood: 'Kế Toán Vỉa Hè', Anh: ketoanviahe, NhaXuatBan: 'PETFOOD', GiaGoc: '99.000đ', TacGia: 'Anoymous',SoLuongDaBan:'20', SoLuongConLai:'30',MucGiamGia:'10%',DiemTrungBinh:'9.0' },
  //     {TenFood: 'Ỷ Thiên Đồ Long Ký', Anh: yThien, NhaXuatBan: 'PETFOOD', GiaGoc: '55.800đ', TacGia: 'KimDung',SoLuongDaBan:'18', SoLuongConLai:'32',MucGiamGia:'10%',DiemTrungBinh:'9.2'},
  //     {TenFood: 'Về nơi có nhiều cánh đồng', Anh: vncncd, NhaXuatBan: 'PETFOOD', GiaGoc: '142.500đ', TacGia: 'Anoymous',SoLuongDaBan:'20', SoLuongConLai:'30',MucGiamGia:'5%',DiemTrungBinh:'9.6' },
  //     {TenFood: 'Osho - Tự tôn', Anh: osho, NhaXuatBan: 'PETFOOD', GiaGoc: '135.000đ', TacGia: 'Anoymous',SoLuongDaBan:'7', SoLuongConLai:'43',MucGiamGia:'0%',DiemTrungBinh:'9.9' },
  //     {TenFood: 'Toán cao cấp tập 1', Anh: toancc, NhaXuatBan: 'PETFOOD', GiaGoc: '112.000đ', TacGia: 'Anoymous',SoLuongDaBan:'38', SoLuongConLai:'12',MucGiamGia:'0%',DiemTrungBinh:'9.5' },
  //   ];
        ...
        <tbody>
          {products.map((item, index) => (
            <tr key={index} className="tableColor">
              <td>{item.Ten}</td>
              <td>
                <img src={`/images/${item.Anh}`} alt={item.TenFood} />
              </td>
              <td>{item.NXB}</td>
              <td>{item.TacGia}</td>
