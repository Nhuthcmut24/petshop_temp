...
exports.updateName = (req, res) => {
  ...
  const query = "UPDATE khachhang SET HoTen=? WHERE TenDangNhap=?";
...
exports.getOrderProduct = (req, res) => {
  ...
  const query =
    "SELECT donhangcoFood.*, Food.Ten, Food.Anh, donhang.XacNhan FROM donhangcoFood, Food, donhang WHERE IDDonHang=? AND donhangcoFood.IDFood=Food.ID AND donhang.ID=donhangcoFood.IDDonHang";
